...
T01=dh_matrix(t1,0.65,0,0)
T12=dh_matrix(-pi/2,0,0,pi/2)
T23=dh_matrix(0,l2-0.25,0,pi/2)
T34=dh_matrix(t2,-0.38,0,pi/2)
T45=dh_matrix(t3,0.42,0,0)
...
def callback(data):
    ...
    T06n=T05.subs([(t1,data.linear.x),(l2,data.linear.y),(t2,data.linear.z),(t3,data.angular.x)]) #modify
