...
def callback(data):
    ...
    T08n=T08.subs([(t1,data.linear.x),(t2,data.linear.y),(t3,data.linear.z),(t4,data.angular.x),(t5,data.angular.y),(t6,data.angular.z),(l1,0.4),(l2,0.455),(a1,0.025),(d1,0.035),(l4,0.42),(l5,0.08)]) #modify
...
def listener():
    rospy.init_node('for_kin_kuka_6_dof', anonymous=True)   
