...
dim=(150,150) 
path="/imt342p2_ws/src/diff_robot/scripts/raw_data_categorical/"
class image_converter:

  def __init__(self):
    self.loaded_model=tf.keras.models.load_model('/imt342p2_ws/src/diff_robot/scripts/post_vs_sign_2.h5') ##Warning (~/)
  ...
  def callback(self,data):
    ...
    with self.graph.as_default(): 
      preds=self.loaded_model.predict(reshaped)
